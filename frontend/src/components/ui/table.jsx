...
const TableHeader = React.forwardRef(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b border-neutral-200 bg-neutral-50/50", className)} {...props} />
));
...
const TableFooter = React.forwardRef(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-neutral-200 bg-neutral-100/50 font-medium [&>tr]:last-child:border-b-0",
      className
    )}
    {...props}
  />
